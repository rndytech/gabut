...
petik = '```'
fake = '©Created By RndyBotz'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "RndyBotz️","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/rndybotz.jpg')
        }}}
       const math = (teks) => {
      ...
      const hideTag = async function(from, text){
	       ...
	       dha.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/rndybotz.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftext = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `*Hai ${pushname}👋*\n  ${moment().utcOffset('+0700').format('HH:mm:ss')} ${moment.tz('Asia/Jakarta').format('DD/MM/YYYY')}`,"title": `Hmm`,'jpegThumbnail': fs.readFileSync('./media/rndybotz.jpg')}}}
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/rndybotz.jpg`)},"title": `©RndyBotz`,"description": "ItsMeBotz", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "RndyBotz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
ᱝ *User :* ${pushname}`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'ALL MENU'},type:1}]

imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/rndybotz.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/rndybotz.jpg`)})).imageMessage
              
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'RndyBotz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'RndyBotz' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by RndyBotz', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
...
//------------------< by RndyBotz >-------------------  
case 'audio1':
man = fs.readFileSync('./AlanBotz/audio1.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio2':
man = fs.readFileSync('./AlanBotz/audio2.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio3':
man = fs.readFileSync('./AlanBotz/audio3.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio4':
man = fs.readFileSync('./AlanBotz/audio4.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio5':
man = fs.readFileSync('./AlanBotz/audio5.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio6':
man = fs.readFileSync('./AlanBotz/audio6.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio7':
man = fs.readFileSync('./AlanBotz/audio7.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
//------------------< bayar menu >-------------------  
case 'bayar':
...
*Chat Owner :* wa.me/6285718366706`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©RndyBotz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/cal_me_jb_alanganz?utm_medium=copy_link`)
             break
      case 'grupbot':
...
reply('_' + err + '_\n\n' + js)
       ...
       if (budy.includes(`@6285718366706`)) {
